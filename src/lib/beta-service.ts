...
function canonicalJourneyDefinitions(): CanonicalMissionDefinition[] {
  return [
    ...
    },
    {
      ...
      shortDescription: 'Connect Certifyd Core to a domain you control using Cloudflare so your public Certifyd presence can be reached securely from the web.',
      inviteCopy: 'Your next Certifyd technical beta mission is to connect your local Certifyd Core installation to a domain you control through Cloudflare. A website is not required, and private/admin surfaces must stay inaccessible publicly.',
      publicStartEnabled: true,
      startHeading: 'Connect Your Core to the Web',
      startIntro: 'Take a working local Core installation and make its intended public surfaces reachable through a domain you control, such as core.artist.com, without exposing private or admin routes. You do not need an existing website.',
      publicInstructions: 'Use your AI coding agent or follow the Certifyd Core documentation directly for Cloudflare Tunnel, domain/DNS, public hostname, Core public-origin configuration and route verification.',
      successCriteria: 'Your public Certifyd page is reachable over HTTPS from a hostname you control, private/admin routes are not reachable publicly, and Core reports named mode online / namedReady: true.',
      milestones: ['Domain control confirmed (website not required)', 'Cloudflare account/access ready or created', 'Domain added or available in Cloudflare', 'Cloudflare Tunnel created or configured', 'Public hostname/subdomain selected, such as core.artist.com', 'DNS/public hostname routing configured', 'Connector token or existing tunnel credentials ready', 'Public hostname and tunnel details saved in Certifyd Core', 'Named tunnel/public sharing started from Core', 'HTTPS verified', 'Public Certifyd page reachable externally', 'Private/admin routes verified inaccessible publicly', 'Core reports named mode online / namedReady: true'],
    },
    {
      sequence: 5,
